...
public class ResultImageHashHandler implements GenericResultHandler<TdApi.File> {
    private final Sender sender = new Sender();
    public static final Logger log = LoggerFactory.getLogger(ResultImageHashHandler.class);
